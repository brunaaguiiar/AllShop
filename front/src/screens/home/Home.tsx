...
export default function Home() {
  ...
  const banners = [
    { titulo: "Oferta especial em notebooks", subtitulo: "Notebook Gamer Lenovo LOQ com 24% de desconto", imagem: "/imagens/notebook.png", produtoId: 1 },
    { titulo: "SSD Kingston em promoção", subtitulo: "Mais velocidade para seu computador com 18% OFF", imagem: "/imagens/SSD Kingston NV3 1TB.png", produtoId: 2 },
    { titulo: "PlayStation 5 Slim", subtitulo: "Console Sony PlayStation 5 Slim com preço especial", imagem: "/imagens/Console PlayStation 5 Slim.png", produtoId: 5 }
  ];

  const categorias = ["Todos", "Games", "Processadores", "Computadores", "Refrigeração", "Periféricos"];
 ...
 const produtosFiltrados =
  ...
  return (
    <main style={{ backgroundColor: "#f3f4f6", minHeight: "100vh", padding: "170px 32px 32px" }}>
         ...
         >
            ...
            >
              <button
                ...
                aria-label={favoritos.includes(produto.produto_id) ? "Remover dos favoritos" : "Adicionar aos favoritos"}
                title={favoritos.includes(produto.produto_id) ? "Remover dos favoritos" : "Adicionar aos favoritos"}
                style={{
                  position: "absolute",
                  top: "12px",
                  right: "12px",
              ...
              src={
               produto.produto_id === 6
                 ...
                 : produto.produto_id === 23
                 ? "/imagens/Cadeira Gamer ThunderX3.png"
                 : produto.produto_id === 24
